...
<head>
    <meta charset="UTF-8">
    <title>编辑管理员-后台管理系统-Admin 1.0</title>
    ...
    <form class="layui-form" id="edit-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="pro_name" required  lay-verify="required" id="pro_name"  autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">商品价格</label>
            <div class="layui-input-block">
                <input type="text" name="pro_price" required  lay-verify="required" id="pro_price" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">商品详情</label>
            <div class="layui-input-block">
                <textarea name="pro_desc" id="pro_desc" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">商品日期</label>
            <div class="layui-inline">
                <input type="text" class="layui-input" id="pro_date" name="pro_date" >
            </div>
        </div>
        <div class="layui-form-item">
